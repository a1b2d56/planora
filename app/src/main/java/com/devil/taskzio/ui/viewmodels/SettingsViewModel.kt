...
import com.devil.taskzio.data.auth.AuthManager
import com.devil.taskzio.data.backup.CloudBackupManager
...
class SettingsViewModel @Inject constructor(
    ...
    private val database: TaskzioDatabase
) : ViewModel() {
    ...
    fun setUserPhotoUrl(url: String)          = viewModelScope.launch { prefsManager.setUserPhotoUrl(url) }
    fun setUserEmail(email: String)           = viewModelScope.launch { prefsManager.setUserEmail(email) }
    ...
    /** Helper to handle authorization results and toggle backup */
    fun toggleBackup() {
        refreshAuthStatus()
    }
