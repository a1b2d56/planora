...
import com.devil.taskzio.data.database.entities.NOTE_COLORS
import com.devil.taskzio.ui.components.richtext.FormatToolbar
import com.devil.taskzio.ui.components.richtext.RichTextEditor
import com.devil.taskzio.ui.components.richtext.RichTextState
...
fun NoteEditorScreen(
    ...
    var selectedColor by remember { mutableStateOf("#1E1E1E") }
    ...
    // Memoize color derivation — toColorInt() and luminance() only need to run when selectedColor changes
    val noteColor    = remember(selectedColor) {
        try { Color(selectedColor.toColorInt()) } catch (_: Exception) { Color(0xFF1E1E1E.toInt()) }
    }
